...
public class RoomAmenityDefinition
{
    public RoomAmenityDefinitionId Id { get; private set; }
    ...
    private RoomAmenityDefinition() { }

    public static RoomAmenityDefinition Create(
        string code,
        string name,
        string? icon = null,
    ...
    {
        return new RoomAmenityDefinition
        {
            Id = RoomAmenityDefinitionId.New(),
    ...
    public static RoomAmenityDefinition CreateSystem(
        string code,
        string name,
        string? icon = null,
        string? category = null)
